...
VALUES ('María', 'García López', 'NIF', '12345678Z', '600123456', 'Primera víctima registrada para pruebas');
...
INSERT INTO Agresion (id_victima, agresor, tipo_agresion, fecha_hora, observaciones)
VALUES (2, 'Familiar cercano', 'sexual', '2024-02-01 18:45:00', 'Requiere atención médica urgente');

INSERT INTO Agresion (id_victima, agresor, tipo_agresion, fecha_hora, observaciones)
VALUES (3, NULL, 'psicológica', '2024-02-10 10:00:00', 'Control y aislamiento social');

INSERT INTO Agresion (id_victima, agresor, tipo_agresion, fecha_hora, observaciones)
VALUES (2, 'Conocido', 'vicaria', '2024-02-15 16:30:00', 'Violencia hacia los hijos');
